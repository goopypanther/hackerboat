...
class RESTdispatchClass {
	public:
		...
		virtual json_t* dispatch (char** tokens, uint32_t* tokenHashes, size_t* tokenLengths, int tokenCnt, int currentToken, char* method, char* body, int bodyLen); /**< Dispatch on the tokenized (and hashed) URI */
		...
		virtual json_t* root (char** tokens, uint32_t* tokenHashes, size_t* tokenLengths, int tokenCnt, int currentToken, char* body, int bodyLen);			/**< Function to execute if this is the last token */
		virtual json_t*	defaultFunc (char** tokens, uint32_t* tokenHashes, size_t* tokenLengths, int tokenCnt, int currentToken, char* body, int bodyLen); 	/**< Function to execute if the next token doesn't match anything in the dispatch table */
...
class rootRESTClass : public RESTdispatchClass {
	public:
		json_t* root (char** tokens, uint32_t* tokenHashes, size_t* tokenLengths, int tokenCnt, int currentToken, char* body, int bodyLen);
		json_t*	defaultFunc  (char** tokens, uint32_t* tokenHashes, size_t* tokenLengths, int tokenCnt, int currentToken, char* body, int bodyLen);
};
