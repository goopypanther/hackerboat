...
TEST(BoatStateTest, Command) {
	...
	EXPECT_NO_THROW(me.pushCmd("SetMode", Pointer("/").GetWithDefault(start, default_val)));
	VLOG(2) << me;
	EXPECT_NO_THROW(me.pushCmd("SetMode", Pointer("/").GetWithDefault(selftest, default_val)));
	VLOG(2) << me;
	EXPECT_NO_THROW(me.pushCmd("SetMode", Pointer("/").GetWithDefault(disarmed, default_val)));
	VLOG(2) << me;
	EXPECT_NO_THROW(me.pushCmd("SetMode", Pointer("/").GetWithDefault(fault, default_val)));
	VLOG(2) << me;
	EXPECT_NO_THROW(me.pushCmd("SetMode", Pointer("/").GetWithDefault(navigation, default_val)));
	VLOG(2) << me;
	EXPECT_NO_THROW(me.pushCmd("SetMode", Pointer("/").GetWithDefault(armedtest, default_val)));
	VLOG(2) << me;
...
TEST(BoatStateTest, SetNavMode) {
	...
	EXPECT_NO_THROW(me.pushCmd("SetNavMode", Pointer("/").GetWithDefault(d, default_val)));
	VLOG(2) << me;
	EXPECT_EQ(me.executeCmds(1), 1);
	VLOG(2) << me;
	EXPECT_EQ(me.getNavMode(), NavModeEnum::AUTONOMOUS);
...
TEST(BoatStateTest, SetHome) {
	...
	EXPECT_NO_THROW(me.pushCmd("SetHome", Pointer("/").GetWithDefault(d, default_val)));
	VLOG(2) << me;
	EXPECT_EQ(me.executeCmds(1), 1);
	VLOG(2) << me;
...
TEST(BoatStateTest, SetWaypoint) {
	...
	EXPECT_NO_THROW(me.pushCmd("SetWaypoint", Pointer("/").GetWithDefault(d, default_val)));
	EXPECT_EQ(me.executeCmds(1), 1);
...
TEST(BoatStateTest, SetWaypointAction) {
	...
	EXPECT_NO_THROW(me.pushCmd("SetWaypointAction", Pointer("/").GetWithDefault(d, default_val)));
...
TEST(BoatStateTest, SetPID) {
	...
	EXPECT_NO_THROW(me.pushCmd("SetPID", Pointer("/").GetWithDefault(d, default_val)));
	VLOG(2) << me;
	EXPECT_EQ(me.executeCmds(1), 1);
	VLOG(2) << me;
